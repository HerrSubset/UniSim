...
public class SimulationParameters {
	...
	public final static int STUDENT_BAR_DESTINATION_CHANCE = 6;
	public final static int STUDENT_DRUNK_TURNS = 4;
	...
	public final static int PHD_STUDENT_BAR_DESTINATION_CHANCE = 4;
	public final static int PHD_STUDENT_DRUNK_TURNS = 3;
	...
	public final static int PHD_BAR_DESTINATION_CHANCE = 2;
	...
	public final static int PROFESSOR_BAR_DESTINATION_CHANCE = 2;
	
	public final static int ACADEMIC_DRUNK_TURNS = 2;
	...
	public final static int TRAINEE_BAR_DESTINATION_CHANCE = 0;
	public final static int TRAINEE_DRUNK_TURNS = 1;
	
	
	public final static int CONSULTANT_LECTURE_HALL_DESTINATION_CHANCE = 10;
	public final static int CONSULTANT_BAR_DESTINATION_CHANCE = 2;
	
	public final static int PARTNER_LECTURE_HALL_DESTINATION_CHANCE = 20;
	public final static int PARTNER_BAR_DESTINATION_CHANCE = 4;
	...
	public final static int CORPORATE_DRUNK_TURNS = 2;
